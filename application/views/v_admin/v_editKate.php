                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <div class="devit-card-custom">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" name="kode_kategori" placeholder="kode_kategori" value="<?php echo $data->kode_kategori ?>">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" name="judul_kategori" placeholder="judul_kategori" value="<?php echo $data->judul_kategori ?>">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input name="deskripsi_kategori" type="text" class="form-control" placeholder="deskripsi_kategori" value="<?php echo $data->deskripsi_kategori ?>">
                                                                        </div>
