                                                    ...
                                                    <div class="review-content-section">
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <input type="text" class="form-control" name="kode_golonganpokok" placeholder="kode_golonganpokok" value="<?php echo $data->kode_golonganpokok ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" name="judul_golonganpokok" placeholder="judul_golonganpokok" value="<?php echo $data->judul_golonganpokok ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="deskripsi_golonganpokok" type="text" class="form-control" placeholder="deskripsi_golonganpokok" value="<?php echo $data->deskripsi_golonganpokok ?>">
                                                                </div>
