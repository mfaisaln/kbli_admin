                                        ...
                                        <?php foreach($Subgol as $data2){?>
                                                ...
                                                <div class="devit-card-custom">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="kode_subgolongan" placeholder="kode_subgolongan" value="<?php echo $data2->kode_subgolongan ?>">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="judul_subgolongan" placeholder="judul_subgolongan" value="<?php echo $data2->judul_subgolongan ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <input name="deskripsi_subgolongan" type="text" class="form-control" placeholder="deskripsi_subgolongan" value="<?php echo $data2->deskripsi_subgolongan ?>">
                                                    </div>
