                                ...
                                <?php foreach($Gol as $data){?>
                                    <div class="devit-card-custom">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="kode_golongan" placeholder="kode_golongan" value="<?php echo $data->kode_golongan ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="judul_golongan" placeholder="judul_golongan" value="<?php echo $data->judul_golongan ?>">
                                        </div>
                                        <div class="form-group">
                                            <input name="deskripsi_golongan" type="text" class="form-control" placeholder="deskripsi_golongan" value="<?php echo $data->deskripsi_golongan ?>">
                                        </div>
