...
<h3 style="text-align: center;">Pilih Sub Golongan</h3>
    ...
    <table id="table" data-toggle="table"  data-search="true">
        <thead class="thead-dark">
          <tr>
            ...
            <th scope="col">Kode Sub Golongan</th>
            <th scope="col">Sub Golongan</th>
            <th scope="col">Deskripsi Sub Golongan</th>
          </tr>
        </thead>
        <tbody>
          <?php
            if( ! empty($subGol)){ // Jika data siswa tidak sama dengan kosong, artinya jika data siswa ada
              foreach($subGol as $data){
                  ...
                  echo "<td>".$data->kode_subgolongan."</td>";
                  echo "<td>".$data->judul_subgolongan."</td>";
                  echo "<td>".$data->deskripsi_subgolongan."</td>";
                  echo "</tr>";
              }
            }
          ?>
